...
var QueryBuilder = exports.QueryBuilder = function () {
    function QueryBuilder(fields) {
        ...
        var maxRules = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
        var maxGroups = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
    ...
    _createClass(QueryBuilder, [{
        ...
        key: "onItemAdd",
        value: function onItemAdd(item) {
            var items = this.view.find(".query-item");
        ...
        key: "onItemRemove",
        value: function onItemRemove(item) {
            var items = this.view.find(".query-item");
...
var QueryGroup = exports.QueryGroup = function () {
    function QueryGroup(parent, builder, depth) {
        var _this = this;

        _classCallCheck(this, QueryGroup);
        ...
        var header = $("<div class='query-header'>"),
        ...
        if (this.parent) {
            ...
            deleteBTN.on("click", function (event) {
                _this.view.remove();
                _this.builder.onItemRemove(_this);
            });
        }
        ...
        operatorWrapper.on("click", function (event) {
            var btn = $(event.target).closest("button", operatorWrapper);
    ...
    _createClass(QueryGroup, [{
        ...
        value: function addGroup() {
            var group = new QueryGroup(this, this.builder, this.depth + 1);
        ...
        value: function addRule() {
            var rule = new QueryRule(this, this.builder);
...
var QueryRule = exports.QueryRule = function () {
    function QueryRule(parent, builder, depth) {
        var _this2 = this;
        ...
        if (this.parent) {
            ...
            deleteBTN.on("click", function (event) {
                _this2.view.remove();
                _this2.builder.onItemRemove(_this2);
            });
        }

        for (var i = 0, l = this.builder.fields.length; i < l; i++) {
            var field = this.builder.fields[i],
        ...
        this.fieldsSelect.on("change", function () {
            _this2.setFilter(_this2.fieldsSelect.find(":selected").data("filter"));
        });
    ...
    _createClass(QueryRule, [{
        ...
        key: "setFilter",
        value: function setFilter(field) {
            this.filterView.empty();
            var filter = field.filter.create(field.field);
...
var TextFilter = exports.TextFilter = function () {
    function TextFilter(operators, placeholder) {
        _classCallCheck(this, TextFilter);

        if (!operators) {
            this.operators = [["Equals", "eq"], ["IEquals", "ieq"], ["Not Equals", "ne"], ["Contains", "contains"], ["IContains", "icontains"], ["Starts With", "startswith"], ["Ends With", "endswith"], ["Is Blank", "isblank"], ["In List", "inlist"], ["Not In List", "notinlist"]];
        } else {
